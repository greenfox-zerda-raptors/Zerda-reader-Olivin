...
INSERT INTO feeds (id, copyright, description, language, link, pub_date, rss_path, title) VALUES (2, NULL , NULL, 'HU-hu', 'http://index1.hu/24ora/', '2017-02-06 14:25:00', 'file:///D:\\Zerda-reader-Olivin\\src\\test\\resources\\indexrssforupdate.xml','Index - 24óra');
...
INSERT INTO feed_items (id, author, description, link, pub_date, title, feed_id) VALUES (11, NULL, 'A tervek szerint novemberben át is adják majd.', ' http://index.hu/belfold/2017/02/06/felmilliardbol_epul_a_szovjet_megszallasi_emlekmu/', '2017-02-06 13:53:00', 'Félmilliárdból épül a szovjet megszállási emlékmű', 2 );
INSERT INTO feed_items (id, author, description, link, pub_date, title, feed_id) VALUES (12, NULL, 'Räikkönen öregszik, de nem változik.', 'http://index.hu/sport/forma1/2017/02/06/kimit_vakacion_zavarni_olyan_mint_ez_az_interju_lett_vele/', '2017-02-06 14:25:00', 'Kimit vakáción zavarni olyan, mint ez az interjú vele', 2 );
