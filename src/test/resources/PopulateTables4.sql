...
INSERT INTO feeds (id, copyright, description, language, link, pub_date, rss_path, title) VALUES (6, NULL , NULL, 'HU-hu', 'http://index.hu/24ora/', '2017-02-02 12:30:00', 'http://444.hu/feed/','444 ');
INSERT INTO feeds (id, copyright, description, language, link, pub_date, rss_path, title) VALUES (5, NULL , NULL, 'HU-hu', 'http://index.hu/24ora/', '2017-02-02 12:30:00', 'http://hvg.hu/rss','HVG');
...
INSERT INTO feeds_for_users (id, read_by_user, starred, feed_item_id, user_id) VALUES (4, 0, 0, 12, 2);
INSERT INTO feeds_for_users (id, read_by_user, starred, feed_item_id, user_id) VALUES (5, 0, 0, 12, 2);
